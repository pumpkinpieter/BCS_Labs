...
IPS_sampledata[,c("posX","posY","posZ","signal","time")]=lapply(IPS_sampledata[,c("posX","posY","posZ","signal","time")],as.numeric)
...
IPS_sampledata[,c("time")]<-IPS_sampledata[,c("time")]*0.001

#Convert its class into a time format using the function `as.POSIXct`
IPS_sampledata[,c("time")]<-as.POSIXct.Date(IPS_sampledata[,c("time")])
class(IPS_sampledata[,c("time")])
```
