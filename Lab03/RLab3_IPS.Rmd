---
title: "Data Visualization Lab: IPS Teams"
...
**Use only tools covered on Tuesday's lecture**.
...
Throughout this section you'll have some freedom to create some useful visualizations for your data.  [Here is a link](https://github.com/rstudio/cheatsheets/blob/main/data-visualization-2.1.pdf) to a `ggplot2` cheat-sheet, and [here is another link](https://r-graph-gallery.com/index.html) to a nice R graph gallery for inspiration.
...
3. Using the data generated from the exercise above, produce one or more visualizations (at most 3) to understand the relationship between 1) orientation angle, 2) location (relative to the access point), and 3) signal strength, using `ggplot2` tools discussed in class. Briefly comment on the relationships you observe in your visualization(s) between orientation angle, distance between locations and access points, and signal strength. 
